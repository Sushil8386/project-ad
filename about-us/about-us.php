        ...
        <div class="container_fluid inner_section py-4 mt-5">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="heading text-center mb-3 d-block"><span class="fs-xl-50 fs-md-40 fs-sm-30  fs-25 fw-bold text-white inner_contant inner_heading">About Us</span></div>
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="row inner_section">
                    <div class="col-12 pb-4"><span class="fw-bold">Baazigar11</span> brings altogether a new game/concept where in you can make predictions on a cricket match in four easy steps and put it on a Cricket Table and win real cash/money.</div>
                    ...
                    Founded in 2023 Baazigar11 is one of its kind Cricket Fantasy App which shall enhance the gaming sector altogether due to its unique gameplay, extremely easy to understand and user friendly interface.
                    </div>
                    <div class="col-12">Baazigar11 game is owned and operated by <span class="fw-bolder text-black">Baazigar11 Technology Pvt Ltd.</span></div>
                </div>
            </div>
        </div>
    </section>
